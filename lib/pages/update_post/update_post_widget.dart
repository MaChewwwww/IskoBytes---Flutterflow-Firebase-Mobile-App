...
class _UpdatePostWidgetState extends State<UpdatePostWidget> {
  ...
  void initState() {
    ...
    _model.postContentTextController ??=
        TextEditingController(text: widget.postData?.body);
                                        ...
                                        TextFormField(
                                          ...
                                          cursorColor:
                                              FlutterFlowTheme.of(context)
                                                  .primary,
                                          validator: _model
                                              .postContentTextControllerValidator
                                              .asValidator(context),
                                        ),
                        ...
                        onPressed: () async {
                          await PostsTable().update(
                            data: {
                              ...
                              'body': _model.postContentTextController.text,
                              'image_path': _model.imageURL,
                            },
