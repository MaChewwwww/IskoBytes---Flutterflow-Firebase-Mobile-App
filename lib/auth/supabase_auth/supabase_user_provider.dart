...
class BlogDemoSupabaseUser extends BaseAuthUser {
  BlogDemoSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> blogDemoSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = BlogDemoSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
